...
class Post{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Video", mappedBy="post")
     */
    private $videos;
    
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\ShareLink", mappedBy="post")
     */
    private $sharelinks;
     ...
     */
    public function addShareLink(\AppBundle\Entity\ShareLink $sharelink){
