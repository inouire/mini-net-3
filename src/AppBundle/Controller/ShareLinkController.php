...
use AppBundle\Entity\ShareLink;
...
class ShareLinkController extends Controller
{
    ...
    public function newAction(Post $post)
    {
        ...
        $sharelink_repo = $em->getRepository('AppBundle:ShareLink');
        ...
        return $this->render('main/createShareLink.html.twig',array(
            'sharelink' => $sharelink
        )); 
    }
    ...
    public function getAction($token)
    {
        ...
        if($sharelink == null){
            ...
            return $this->render('main/getShareLink.html.twig',array(
                'sharelink' => $sharelink
            ));
        }        
    }
    ...
    public function getImageAction($token, Image $image, $is_thumbnail=false)
    {
        ...
        return $this->forward('AppBundle:Image:getImage', array(
            'image'  => $image,
    ...
    public function getVideoAction($token, Video $video)
    {
        ...
        // forward to regular controlelr
        return $this->forward('AppBundle:Video:getVideo', array(
            'video'  => $video,
        ));
    }
    ...
    public function getVideoThumbnailAction($token, Video $video)
    {
        ...
        // forward to regular controlelr
        return $this->forward('AppBundle:Video:getVideoThumbnail', array(
            'video'  => $video,
        ));
    }
}
