...
class AlbumController extends Controller
{
    ...
    public function viewPicturesAlbumAction($year,$month){
        ...
        $image_repo = $em->getRepository('AppBundle:Image');
        ...
        if(count($image_list)>0){
            ...
            return $this->render('main/album.html.twig',array(
            ...
            return $this->render('empty/noAlbum.html.twig',array(
                'requested_date' => $requested_date,
                'requested_year' => $year,
                'requested_month' => $month,
                'months_of_year' => $months_of_year
    ...
    public function viewTagAlbumAction($tag){
        ...
        $image_list = $em->getRepository('AppBundle:Image')
        ...
        return $this->render('main/albumByTag.html.twig',array(
            'image_list' => $image_list,
            'tag' => $tag,
            'tags' => $tags
        ));
    ...
    public function viewVideosAlbumAction(){
        //get all the videos
        $em = $this->getDoctrine()->getManager();
        $video_repo = $em->getRepository('AppBundle:Video');
